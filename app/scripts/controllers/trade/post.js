...
/**
 * @ngdoc function
 * @name aTechClientApp.controller:TradePostCtrl
 * @description
 * # TradePostCtrl
 * Controller of the aTechClientApp
 */
angular.module('aTechClientApp')
    .controller('TradePostCtrl', function ($scope, Page, $cookieStore, apiUrl, $http, ngNotify, $location, Loading) {
        ...
        var uploader = Qiniu.uploader({
            ...
            uptoken : 'K8eqr1qikcsa2OXUkg_gMxIX16cCPR9U8yULRKDr:IzHxlxCS1STHwjaPFEKA9AjXtpM=:eyJzY29wZSI6Im5rMTEwLWltYWdlcyIsImRlYWRsaW5lIjoxNDY0OTQ2ODk1LCJzYXZlS2V5IjoicWluaXVfY2xvdWRfc3RvcmFnZV8xNDY0OTQzMjk1IiwibWltZUxpbWl0IjoiaW1hZ2VcLyoifQ==', // uptoken 是上传凭证，由其他程序生成
            // TODO
