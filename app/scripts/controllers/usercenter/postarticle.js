...
angular.module('aTechClientApp')
    .controller('UsercenterPostarticleCtrl', function ($scope, Page, $cookieStore, apiUrl, $http, ngNotify, $location, Loading, cloudUrl) {
            ...
            var uploader = Qiniu.uploader({
                ...
                init: {
                    ...
                    'FileUploaded': function (up, file, info) {
                        ...
                        $scope.cateImage = domain + res.key; //获取上传成功后的文件的Url
